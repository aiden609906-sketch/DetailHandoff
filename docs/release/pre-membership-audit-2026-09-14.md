...
- Latest verified merged-main CI before the current branch: [run 34828946923](https://github.com/aiden609906-sketch/DetailHandoff/actions/runs/34828946923), commit `e0d07ff`: app build, 149/0 unit tests, 11/0 iPhone UI tests, and 11/0 iPad UI tests passed. The current isolated candidate [run 34931386078](https://github.com/aiden609906-sketch/DetailHandoff/actions/runs/34931386078), commit `f670bc8`, passed the build, 149/0 unit tests, and 13/0 UI tests on each simulator, including job relaunch persistence, backup-export modal presentation, and Recently Deleted restore. The exporter test no longer manipulates Apple's unstable Files-window internals; physical save/cancel destinations remain open.
